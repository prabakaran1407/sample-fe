...
const TicketManagement = () => {
  ...
  const [_selectedData, setSelectedData] = useState<any | null>(null);
  const [_open, setOpen] = React.useState(false);
  const auth = useAppSelector((state) => state.auth);
  const [_isAddOrEdit, setIsAddOrEdit] = useState<any>("");
  ...
  const getDropDownData = async () => {
    try {
      ...
      const priorityData = await GeneralApiService.accessModel(
        "taskpriorities",
        {
          where: {
                ...
                <Textfield
                  ...
                  value={
                    filterOptions.fromDate
                      ? moment(filterOptions.fromDate).format("YYYY-MM-DD")
                      : ""
                  }
                />
              </Grid>
                ...
                <Textfield
                  ...
                  value={
                    filterOptions.toDate
                      ? moment(filterOptions.toDate).format("YYYY-MM-DD")
                      : ""
                  }
                />
              </Grid>

...
async createRoomRentAllocation(payload:any){
  const URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.CREATE_ROOMRENT_ALLOCATION)
  return await this.AXIOS.post(URL,payload);
}


async createTravelAmountAllocation(payload:any){
  const URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.CREATE_TRAVEL_ALLOCATION)
  return await this.AXIOS.post(URL,payload);
}


async  getAllAmountAllocationData(status: any) {
  const URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.GET_ALL_AMOUNT_ALLOCATIONS)
...
async getAmountAllocationData(data: any) {
  delete data.amount;
   delete data.costOfRoom;
  const URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.GET_AMOUNT_ALLOCATION)
    return await this.AXIOS.get(`${URL}?where=${JSON.stringify(
      data
    )}`);
  }
...
//   );
// }
async getAllAmountAllocationDataByType(status: any,
  typeOfClaim: any,
  organization_id: any) {
  const URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.GET_ALL_AMOUNTALLOCATION_BYTYPE)
    return await this.AXIOS.get(`${URL}?types=${typeOfClaim}&status=${status}&organization_id=${organization_id}`);
  }
...
async getRoomRentAllocationDataByType(status: any,
  typeOfClaim: any,
  organization_id: any) {
  const URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.GET_ALL_ROOMALLOCATION_BYTYPE)
    return await this.AXIOS.get(`${URL}?typeOfClaim=${typeOfClaim}&status=${status}&organization_id=${organization_id}`);
  }
...
async getTravelAmountAllocationData(data: any) {
  delete data.amount;
  delete data.costOfRoom;
  const URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.GET_TRAVEL_ALLOCATION)
    return await this.AXIOS.get(`${URL}?where=${JSON.stringify(
      data
    )}`);
  }
...
//   );
// }
async getAllTravelAmountAllocationDataByType( status: any,
  typeOfTravel: any,
  organization_id: any) {
  const URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.GET_ALL_TRAVELALLOCATION_BYTYPE)
    return await this.AXIOS.get(`${URL}?typeOfTravel=${typeOfTravel}&status=${status}&organization_id=${organization_id}`);
  }
...
async getRoomRentAllocationData(status: any, organization_id: any) {
  const URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.GET_ROOMRENT_ALLOCATION)
    return await this.AXIOS.get(`${URL}?status=${status}&organization_id=${organization_id}`);
  }
...
async getAllRoomRentAllocationData(data: any) {
  delete data.amount;
  delete data.costOfRoom;
  const URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.GET_ALL_ROOMRENT_ALLOCATIONDATA)
    return await this.AXIOS.get(`${URL}?where=${JSON.stringify(
      data
    )}`);
  }
...
async  updateAllocationData(data: any, id: any) {
  let URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.UPDATE_AMOUNT_ALLOCATION)
  if (id) URL += `/${id}`;
...
async  updateRoomAllocationData(data: any, id: any) {
  let URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.UPDATE_ROOMRENT_ALLOCATION)
  if (id) URL += `/${id}`;
  return await this.AXIOS.put(URL,data);
}
...
async  updateTravelAllocationData(data: any, id: any) {
  let URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.UPDATE_TRAVEL_ALLOCATION)
  if (id) URL += `/${id}`;
  return await this.AXIOS.put(URL,data);
}
...
async  getRoomRentAmountAllocationById(id: any) {
  let URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.GET_ONE_ROOMRENT)
  if (id) URL += `/${id}`;
  return await this.AXIOS.get(URL,id);
}
async  getFixedAmountList(payload: any) {
  let URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.FIXED_AMOUNT_LIST)
  
  return await this.AXIOS.post(URL, payload);
}
async  getTravelAmountList(payload: any) {
  let URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.TRAVEL_ALLOCATION_LIST)
  
  return await this.AXIOS.post(URL, payload);
}
async  getRoomRentList(payload: any) {
  let URL = getApiRoute(API_ROUTES?.ADMIN?.AMOUNTALLOCATION?.ROOMRENT_ALLOCATION_LIST)

...
const PrimaryView = () => {
  ...
  console.log("prmary view of sales==========", primaryView);
  ...
  const handleApprove = async () => {
    try {
      ...
      setLoading(true);
      await saleService.approveSale(primaryView?._id, payload);
      setLoading(false);
      navigate(-1);
    } catch (error) {
  ...
  const isButtonDisabled = primaryView?.status === "approved";

  const tableHeader = primaryView?.sales;
        ...
        <Grid container spacing={2}>
          <Grid item xs={6}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <Typography>{primaryView?.user?.firstName || "-"}</Typography>
              </Grid>
            </Grid>
          </Grid>
          <Grid item xs={6}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <Typography>
                  {primaryView?.customer?.customerName || "-"}
                </Typography>
              </Grid>
            </Grid>
          </Grid>
          <Grid item xs={6}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <Typography>
                  {primaryView?.customer?.contactPerson || "-"}
                </Typography>
              </Grid>
            </Grid>
          </Grid>
          <Grid item xs={6}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <Typography>
                  {primaryView?.customer?.contactNumber || "-"}
                </Typography>
              </Grid>
            </Grid>
          </Grid>
          <Grid item xs={6}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <Typography>{primaryView?.orderNo || "-"}</Typography>
              </Grid>
            </Grid>
          </Grid>
          <Grid item xs={6}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={6}>
                <Typography
                  style={{
                    backgroundColor:
                      primaryView?.status === "open"
                        ? "#ffe0b2"
                        : primaryView?.status === "approved"
                        ? "#C6F1DA"
                        : "transparent",
                    padding: "4px",
                    borderRadius: "10px",
                ...
                >
                  {primaryView?.status
                    ? primaryView?.status.toUpperCase()
                    : "-"}
                </Typography>
              </Grid>
            </Grid>
          ...
          <Grid item xs={12}>
            <TableContainer>
              <Table>
                ...
                <TableBody>
                  {Object.keys(primaryView.sales).map((productTypeKey) =>
                    Object.keys(primaryView.sales[productTypeKey]).map(
                      (productName) => {
                        const products =
                          primaryView.sales[productTypeKey][productName];

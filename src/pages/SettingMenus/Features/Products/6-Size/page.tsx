...
// ************** | Form schema
import { productSizeSchema } from "../../../../../data/yup/settings/settings.ts";
...
function AddEditViewModal(props: IAddEditViewModal) {
  ...
  const handleSubmit = async (value: Record<string, any>) => {
    try {
      ...
      let query = `?setting_type=${CONSTANT_DATA?.PRODUCT_SETTING_TYPES[0]}&sub_type=${CONSTANT_DATA?.PRODUCT_SETTING_SUB_TYPES[5]}`;
      if (isEdit) {
        payload = {
          ...payload,
      ...
      if (!error?.response?.data?.status) {
        if(error?.response?.data?.response?.isDuplicate){
          formik.setFieldError('size', error?.response?.data?.message)
          return 
        }
              ...
              <Box>
                ...
                <AutoComplete
                  ...
                  onChange={(_, selectedOption: Record<string, any>) => {
                    ...
                    setApiCallState(getApiCallableState(CONSTANT_DATA?.PRODUCT_SETTING_SUB_TYPES, CONSTANT_DATA?.PRODUCT_SETTING_SUB_TYPES[1]))
                  }}
                  disabled={isView || isEdit}
                />
              </Box>
              ...
              <Box>
                ...
                <AutoComplete
                  ...
                  onChange={(_, selectedOption: Record<string, any>) => {
                    ...
                    setApiCallState(getApiCallableState(CONSTANT_DATA?.PRODUCT_SETTING_SUB_TYPES, CONSTANT_DATA?.PRODUCT_SETTING_SUB_TYPES[2]))
                  }}
                  disabled={isView || isEdit}
                />
              </Box>
              ...
              <Box>
                ...
                <AutoComplete
                  ...
                  onChange={(_, selectedOption: Record<string, any>) => {
                    ...
                    setApiCallState(getApiCallableState(CONSTANT_DATA?.PRODUCT_SETTING_SUB_TYPES, CONSTANT_DATA?.PRODUCT_SETTING_SUB_TYPES[3]))
                  }}
                  disabled={isView || isEdit}
                />
              </Box>
              ...
              <Box>
                ...
                <AutoComplete
                  ...
                  onChange={(_, selectedOption: Record<string, any>) => {
                    ...
                    setApiCallState(getApiCallableState(CONSTANT_DATA?.PRODUCT_SETTING_SUB_TYPES, CONSTANT_DATA?.PRODUCT_SETTING_SUB_TYPES[4]))
                  }}
                  disabled={isView || isEdit}
                />
              </Box>
            ...
            <Grid item xs={4}>
              <Box>
                ...
                <Textfield
                  ...
                  type="text"
                  name="size"
                  value={(formik?.values?.size || "").trimStart()}
...
function ProductSize() {
  ...
  console.log('filterObjectSIZE',filterobject)
  ...
  const handleDelete = (value: TNestedObj) => {
    ...
    setOpenConfirmation({
      ...
      message: `Are you sure you want to deactivate this size?`,
    });
  };
  ...
  const handleActivate = (value: Record<string, any>) => {
    ...
    setOpenConfirmation({
      open: true,
      title: "Activate Size",
      message: `Are you sure you want to activate this size?`,
    });
  };
  ...
  const getList = async () => {
    ...
    let query = `?setting_type=${CONSTANT_DATA?.PRODUCT_SETTING_TYPES[0]}&sub_type=${CONSTANT_DATA?.PRODUCT_SETTING_SUB_TYPES[5]}&isCount=true&listType=LIST`;
  ...
  const getListFilter = async () => {
    ...
    let query = `?setting_type=${CONSTANT_DATA?.PRODUCT_SETTING_TYPES[0]}&sub_type=${CONSTANT_DATA?.PRODUCT_SETTING_SUB_TYPES[5]}&isCount=true&listType=DROPDOWN_LIST`;
      ...
      <div>
        ...
        >
          <ProductSettingBulkUpload
            ...
            sub_type={CONSTANT_DATA?.PRODUCT_SETTING_SUB_TYPES[5]}
          />
        </MyDrawer>
        <ActionConfirmation
